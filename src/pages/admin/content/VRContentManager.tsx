...
import toast from 'react-hot-toast';
    ...
    try {
      ...
      toast.success('Lưu nội dung VR thành công!');
    } catch (error) {
      toast.error('Có lỗi khi lưu nội dung VR!');
    }
    // ...existing code...
    try {
      // ...existing code for deleting...
      toast.success('Xóa nội dung VR thành công!');
    } catch (error) {
      toast.error('Có lỗi khi xóa nội dung VR!');
    }
import {
  Headset,
  Plus,
