...
import { FileText, Image, Video, Download, Mic } from 'lucide-react';
          ...
          {categories.map((category: any, index: number) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col h-full"
              >
                ...
                <Link
                  to="/documents"
                  className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 mt-auto"
                >
                  <Download size={18} />
